...
function editCategory($edit )
{
	...
	// Imagelist
	$lists['image'] 			= JHTML::_('list.images',  'image', $row->image, null, '/images/stories/' );
	...
	$params						= new JParameter( $row->params, JPATH_COMPONENT.DS.'parametros.xml', 'params' );
	$lists['params']			= $params->render('params');
...
function saveCategory()
{
	...
	if (!$row->id) {
		...
		$row->ordering = $row->getNextOrder( $where );
			...
			$parametros		= JRequest::getVar( 'params', null, 'post', 'array' );
