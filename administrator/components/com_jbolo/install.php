 ...
 *
 * Modified from the Joom!Fish installation package
 */
...
<img src="../components/com_jbolo/img/chat.png" align="left" />
<h2>JBolo! Installation Status</h2>
<table class="adminlist">
	...
	<tbody>
		<tr class="row0">
			<td class="key"><?php echo 'JBolo! '.JText::_('Component'); ?></td>
