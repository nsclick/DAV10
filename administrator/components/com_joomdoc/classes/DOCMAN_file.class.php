 ...
 * @version $Id: DOCMAN_file.class.php 608 2008-02-18 13:31:26Z mjaz $
 * @package JoomDOC
...
class DOCMAN_File
{
	...
	*/
	...
	{
		$path = &DocmanFactory::getPathName( $path );
		if (!is_dir( $path )) {
			$path = dirname( $path );
	...
	*/
    ...
    function getDate($type = 'm') {
        ...
        return strftime( _DM_DATEFORMAT_LONG, $date + ($mosConfig_offset*60*60) );
