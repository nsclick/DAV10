 ...
 * @version $Id: DOCMAN_jbrowser.class.php 561 2008-01-17 11:34:40Z mjaz $
 * @package JoomDOC
...
if (defined('_DOCMAN_jbrowser')) {
    return true;
} else {
    define('_DOCMAN_jbrowser', 1);
}

// we don't need this if we're in Joomla 1.5 or up
if( defined('_DM_J15') ) {
