 ...
 * @version $Id: DOCMAN_params.class.php 561 2008-01-17 11:34:40Z mjaz $
 * @package JoomDOC
	...
	function _renderStandard(&$element, $name)
	{
		...
		foreach ($element->childNodes as $param)
		{
			...
			if($type == 'heading') {
				...
				$html[] = '<td width="30%" style="text-align:right;vertical-align:top;font-weight:bold">' . $result[0] . '</td>';
                $html[] = '<td width="24" style="text-align:left;vertical-align:top">' . $result[2] . "</td>";
				$html[] = '<td width="100%" style="text-align:left;vertical-align:top">' . $result[1] . '</td>';
