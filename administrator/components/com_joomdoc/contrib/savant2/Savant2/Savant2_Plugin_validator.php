...
class Savant2_Plugin_validator extends Savant2_Plugin
{
    ...
    */
    ...
    function plugin($params = null)
    {
        ...
        if(defined('_DM_J15')) {
        	$link = $mosConfig_live_site."/index.php?option=com_joomdoc&task=$task&tmpl=component";
        } else {
            $link = $mosConfig_live_site."/index2.php?option=com_joomdoc&task=$task&no_html=1";
        }
        if (is_array($params)) {
