...
class HTML_DMFiles
{
        ...
        for ($i = 0, $n = count($rows);$i < $n;$i++) {
            $row = &$rows[$i];
          	?>
            	...
            	<td align="center">
                <a href="index2.php?option=com_joomdoc&section=files&task=update&old_filename=<?php echo $row->name;?>"><img src="<?php echo $mosConfig_live_site;?>/administrator/components/com_joomdoc/images/dm_upload_16.png" alt="<?php echo _DML_UPDATE;?>" border="0" /></a>
            	</td>
			<?php
            $k = 1 - $k;
        }
    ...
    function uploadWizard(&$lists)
    {
       ...
       <form action="index2.php?option=com_joomdoc&section=files&task=upload&step=2" method="post">
       <table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminform">
        ...
        <tr>
          <td width="38%" rowspan="4" align="center">
	        <div align="right" >
	         <img src="<?php echo $mosConfig_live_site;?>/administrator/components/com_joomdoc/images/dm_upload_48.png">
            </div>
		  </td>
    ...
    function uploadWizard_http($old_filename = null)
    {
		...
		<form action="index2.php?option=com_joomdoc&section=files&task=upload&step=3&method=http&old_filename=<?php echo $old_filename;?>" method="post" enctype="multipart/form-data" onSubmit="MM_showHideLayers('Layer1','','show')" name="fm_upload">
		...
		<div id="Layer1" style="position:absolute; margin-left: auto; margin-right: auto;  width:200px; height:130px; z-index:150; visibility: hidden; left: 14px; top: 11px; background-color: #99989D; layer-background-color: #FF0000; border: 3px solid #F19518;">
			...
			<div align="center" class="style1">
				...
				<p align="center" class="style2"><img src="<?php echo $mosConfig_live_site;?>/administrator/components/com_joomdoc/images/dm_progress.gif" ></p>
        ...
        <tr >
			...
			<div align="right"><img src="<?php echo $mosConfig_live_site;?>/administrator/components/com_joomdoc/images/dm_upload_48.png">
            </td>
    ...
    function uploadWizard_transfer()
    {
    	...
    	<form action="index2.php?option=com_joomdoc&section=files&task=upload&step=3&method=transfer" method="post" onSubmit="MM_showHideLayers('Layer1','','show')">
        <?php dmHTML::adminHeading( _DML_TRANSFERFROMWEB, 'files' )?>
        <table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminform">
        <tr>
            <td width="40%" align="center"> <div align="right"><img src="<?php echo $mosConfig_live_site;?>/administrator/components/com_joomdoc/images/dm_upload_48.png">
            </td>
    ...
    function uploadWizard_sucess(&$file, $batch = 0, $old_filename = null, $show_completion = 1)
    {
        ...
        if ($old_filename <> '1') {
            $mainframe->redirect("index2.php?option=com_joomdoc&section=files", "&quot;" . $old_filename . "&quot; - " . _DML_DOCUPDATED);
        }
        ?>
	...
	<!-- Give them a nice sub menu -->
  	<?php
    	...
    	<tr>
    		<td>
    		<div align="right">
    			<a href="index2.php?option=com_joomdoc&section=documents&task=new&uploaded_file=<?php echo $file->name;?>">
	...
	<td>
		<div align="right">
			<a href="index2.php?option=com_joomdoc&section=files&task=upload">
	...
	<tr>
		<td>
			<div align="right">
				<a href="index2.php?option=com_joomdoc&section=files">
