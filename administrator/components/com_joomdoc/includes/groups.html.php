...
class HTML_DMGroups
{
            ...
            for ($i = 0, $n = count($rows);$i < $n;$i++) {
                ...
                ?>
    				<input type="checkbox" id="cb<?php echo $i;?>" name="cid[]" value="<?php echo $row->groups_id;?>" onclick="isChecked(this.checked);" />
    					...
    					<td width="10%" align="center"><a href="index2.php?option=com_joomdoc&section=groups&task=emailgroup&gid=<?php echo $row->groups_id;?>"><img src="<?php echo $mosConfig_live_site?>/administrator/components/com_joomdoc/images/dm_sendemail_16.png" border=0></a></td>
    			  <?php
                echo "</tr>";
                $k = 1 - $k;
            }
  ...
  <?php require_once ("../components/com_joomdoc/footer.php");
    }
    ...
    function editGroup($option, &$row, $usersList, $toAddUsersList)
    {
        ...
        include_once($mosConfig_absolute_path."/components/com_joomdoc/footer.php");
    }
