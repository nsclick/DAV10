...
class HTML_DMThemes {
    function showThemes(&$rows, &$pageNav)
    {
		...
		<?php
        require_once ("../components/com_joomdoc/footer.php");
    }
    ...
    function themeInstalled() {
		...
		<table width="100%" border="0" cellpadding="4" cellspacing="2" class="adminform">
			...
			<tr>
				<td>
                <a href='index2.php?option=com_joomdoc&task=config'>
		...
		<?php
        include "../components/com_joomdoc/footer.php";
    }
