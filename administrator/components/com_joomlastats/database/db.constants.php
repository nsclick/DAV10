...
define('_JS_DB_IPADD__TYPE_NOT_IDENTIFIED_VISITOR',  0);
define('_JS_DB_IPADD__TYPE_REGULAR_VISITOR',         1);
define('_JS_DB_IPADD__TYPE_BOT_VISITOR',             2);
...
define('_JS_DB_BRWSR__KEY_BROWSER_UNKNOWN',          '');
define('_JS_DB_BRWSR__NAME_BROWSER_UNKNOWN',         'Unknown');
 ...
 *
 *  NOTICE: This class will NOT be integrated with #__jstats_browsers beacuse #__jstats_browsers and #__jstats_bots will be integrated together (and result will be a big table)
 */
