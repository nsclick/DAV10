...
$introduce_msg		= $JSTemplate->generateHeaderIconAndTitleForJ10( 'JoomlaStats', JTEXT::_( 'Status' ) );
...
<div style="text-align: left;">
	<div style="width:95%; border: 1px solid #EFEFEF; margin:5px auto 5px auto; padding:5px;">
		...
		<tr>
			...
			<td style="padding: 0px; text-align: right; vertical-align: top; font-weight: bold;">
				JoomlaStats version:&nbsp;<?php echo $JSTemplate->getJSVersionStr( $this->JSConf->JSVersion ); ?>
			</td>
		</tr>
		</table>	
		<?php
	...
	<div style="text-align:center; color:#9F9F9F; font-size:0.9em">
		&copy;2003-<?php echo date( 'Y' ); ?> JoomlaStats Team - All rights reserved.<br />
