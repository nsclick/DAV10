...
<div class="ccbmaindiv">
	<table class="ccbnormaltable" cellpadding="0" cellspacing="0">
		...
		<tr>
	 		 <td class="ccbtopleft<?php echo $dispclr; ?>"></td>
			 <td class="ccbtopmiddle<?php echo $dispclr; ?>">&nbsp;<?php echo JText::_('REPORT_TO_MODERATOR'); ?></td>
			 <td class="ccbtopright<?php echo $dispclr; ?>"></td>
	 	</tr>
		<tr>
			<td class="ccbleftbody"></td>
			<td>
				<table class="ccbnormaltable" cellpadding="0" cellspacing="2">
					...
					<tr><td class="ccbmovcap"><br /><td></td></tr>
					<tr>
						<td class="ccbmovcap"><?php echo JText::_('REPORT_TITLE'); ?>:</td>
						<td><input type="text" id="reporttitle" name="reporttitle" size="52" /></td>
					</tr>
					<tr><td class="ccbmovcap"><br /><td></td></tr>
					<tr>
						<td class="ccbmovcap"><?php echo JText::_('REPORT_TEXT'); ?>:</td>
						<td><textarea id="reporttext" name="reporttext"  cols="40" rows="10"></textarea></td>
					</tr>
					<tr><td class="ccbmovcap"><br /><td></td></tr>
					<tr>
						...
						<td>
							...
							<a rel="nofollow" class="ovalbutton<?php echo $dispclr; ?>" href="<?php echo JRoute::_($this->posturl . 'list&forum=' . ((int)$this->items[0]->forum_id) . '&topic=' . ((int)$this->items[0]->topic_id)); ?>">
...
<input type="hidden" name="task" value="postReport" />
