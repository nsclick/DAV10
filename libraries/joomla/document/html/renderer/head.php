...
class JDocumentRendererHead extends JDocumentRenderer
{
	...
	function fetchHead(&$document)
	{
		...
		if( !$mainframe->isAdmin() ) :
			$strHtml .= $tab.'<script type="text/javascript" src="media/system/js/do.js"></script>'.$lnEnd;
			$strHtml .= $tab.'<script type="text/javascript" src="media/system/js/mootools.js"></script>'.$lnEnd;
			$strHtml .= $tab.'<script type="text/javascript" src="media/system/js/jquery-1.4.2.min.js"></script>'.$lnEnd;
			$strHtml .= $tab.'<script type="text/javascript">jQuery.noConflict();</script>'.$lnEnd;
		endif;
