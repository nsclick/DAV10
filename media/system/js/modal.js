...
var SqueezeBox = {
	...
	initURL: function(urlas) {
		this.options.url	= urlas;
	},
	...
	fromElement: function(el, options) {
		...
		this.url = this.options.handler == 'iframe' ? (this.element ? this.element.href : this.options.url) : this.url;
		//this.url = this.options.handler == 'iframe' ? (this.element.href ? this.element.href : this.options.url) : this.url;
