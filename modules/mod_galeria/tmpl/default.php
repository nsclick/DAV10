...
?>
<div class="mod_boxshome mod_galeria" align="left">
	<h2><?php echo $datos->subtitulo;?></h2>
	<h1><?php echo $datos->titulo;?></h1>
    <div class="noticia">
      <table width="265" border="0" cellpadding="0" cellspacing="0" class="mod_galeria">
        <tr>
        ...
        <?php endif; ?>
          <td align="left" valign="top" style="padding-left:10px;">
            ...
            <div align="right" style="padding-top:10px;" class="link"><a href="<?php echo $datos->catlink;?>" title="Ver m&aacute;s"><img src="<?php echo $template;?>/imagenes/btn_mod_noticias_vermas.jpg" alt="Ver m&aacute;s" title="Ver m&aacute;s" border="0" /></a></div>
          </td>
        </tr>
      </table>
    </div>
