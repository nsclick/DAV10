...
class modMainMenuHelper
{
	...
	function render(&$params, $callback)
	{
		...
		{
			/* Clínica Dávila */
			case 'davila_principal':
			case 'davila_suphome':
			case 'davila_supcontenido':
			case 'davila_pie':
				//ob_start();
				// Incluimos la clase del menú Dávila
				require_once(dirname(__FILE__).DS.'davila.php');
				$MenuDavila	= new MenuDavila( $params, $params->get( 'menu_style', 'list' ) );
				//ob_end_clean();
				$MenuDavila->render();
				break;
				
			/* Gestión Proyectos TI */
			case 'gpti_principal':
				ob_start();
				// Incluimos la clase del menú Dávila
				require_once(dirname(__FILE__).DS.'gpti.php');
				$MenuGpti	= new MenuGpti( $params, $params->get( 'menu_style', 'list' ) );
				ob_end_clean();
				$MenuGpti->render();
				break;
