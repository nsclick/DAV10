<?php
	...
	//$dsn = 'odbc://user:pwd@localhost/mydb?persist'
	require_once ("adodb5/adodb.inc.php"); 
	$dblink	= ADONewConnection("oci8");
	$dblink->debug = true;
	//$dblink	= ADONewConnection("odbc");
	
	if( $dblink->Connect("DAVILA_INTRA", "INTRANET", "INTRA") ) :
	//if( $dblink->Connect(false, "INTRANET", "INTRA") ) :
	//if( $dblink->PConnect(false, 'INTRANET', 'INTRA', 'DAVILA_INTRA') ) :
	//if( $dblink->Connect("localhost", "INTRANET", "INTRA","DAVILA_INTRA") ) :
		echo "OK<br /><br />";
	else :
		echo "Error<br /><br />";
	endif;
