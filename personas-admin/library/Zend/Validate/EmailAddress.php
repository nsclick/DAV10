...
class Zend_Validate_EmailAddress extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        ...
        self::INVALID_FORMAT     => "'%value%' no es un email válido",
        
        //self::INVALID_HOSTNAME   => "'%hostname%' is no valid hostname for email address '%value%'",
        self::INVALID_HOSTNAME   => "'%hostname%' no es un dominio válido para el email '%value%'",

        //self::INVALID_MX_RECORD  => "'%hostname%' does not appear to have a valid MX record for the email address '%value%'",
        self::INVALID_MX_RECORD  => "'%hostname%' no parece tener un registro MX válido para el email '%value%'",

        //self::INVALID_SEGMENT    => "'%hostname%' is not in a routable network segment. The email address '%value%' should not be resolved from public network",
        self::INVALID_SEGMENT    => "'%hostname%' no es un segmento de red ruteable. El email '%value%' no debe ser resolvido desde una red pública",
        
        //self::DOT_ATOM           => "'%localPart%' can not be matched against dot-atom format",
        self::DOT_ATOM           => "'%localPart%' no calza con formato punto-algo (Ej: .cl)",
        
        //self::QUOTED_STRING      => "'%localPart%' can not be matched against quoted-string format",
        self::QUOTED_STRING      => "'%localPart%' no calza con el formato ''",

        //self::INVALID_LOCAL_PART => "'%localPart%' is no valid local part for email address '%value%'",
        self::INVALID_LOCAL_PART => "'%localPart%' no es una parte local válida para el email '%value%'",

        //self::LENGTH_EXCEEDED    => "'%value%' exceeds the allowed length",
        self::LENGTH_EXCEEDED    => "'%value%' excede el largo permitido",
    );
