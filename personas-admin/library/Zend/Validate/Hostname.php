...
class Zend_Validate_Hostname extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        ...
        self::CANNOT_DECODE_PUNYCODE  => "'%value%' parece ser un host DNS pero la notación del código puny no puede ser decodificado",
        
        //self::INVALID                 => "Invalid type given. String expected",
        self::INVALID                 => "Caracteres inválidos",

        //self::INVALID_DASH            => "'%value%' appears to be a DNS hostname but contains a dash in an invalid position",
        self::INVALID_DASH            => "'%value%' parece ser un host DNS pero contiene un guión en una posicion inválida",

        //self::INVALID_HOSTNAME        => "'%value%' does not match the expected structure for a DNS hostname",
        self::INVALID_HOSTNAME        => "'%value%' no calza con la esctructura esperada de un host DNS",

        //self::INVALID_HOSTNAME_SCHEMA => "'%value%' appears to be a DNS hostname but cannot match against hostname schema for TLD '%tld%'",
        self::INVALID_HOSTNAME_SCHEMA => "'%value%' parece ser un host DNS, pero no calza con el esquema host para el TLD '%tld%'",

        //self::INVALID_LOCAL_NAME      => "'%value%' does not appear to be a valid local network name",
        self::INVALID_LOCAL_NAME      => "'%value%' no parece ser un nombre de red local válido",

        //self::INVALID_URI             => "'%value%' does not appear to be a valid URI hostname",
        self::INVALID_URI             => "'%value%' no parece ser un host URI válido",

        //self::IP_ADDRESS_NOT_ALLOWED  => "'%value%' appears to be an IP address, but IP addresses are not allowed",
        self::IP_ADDRESS_NOT_ALLOWED  => "'%value%' parece ser una dirección IP, pero las direcciones IP no están permitidas",

        //self::LOCAL_NAME_NOT_ALLOWED  => "'%value%' appears to be a local network name but local network names are not allowed",
        self::LOCAL_NAME_NOT_ALLOWED  => "'%value%' parece ser un nombre de red local, pero los nombre de red local no están permintidos",

        //self::UNDECIPHERABLE_TLD      => "'%value%' appears to be a DNS hostname but cannot extract TLD part",
        self::UNDECIPHERABLE_TLD      => "'%value%' parece ser un host DNS pero no de puede extrear la parte correspondiente al TLD",

        //self::UNKNOWN_TLD             => "'%value%' appears to be a DNS hostname but cannot match TLD against known list",
        self::UNKNOWN_TLD             => "'%value%' parece ser un host DNS pero su TLD no calza con la lista conocida",
    );
