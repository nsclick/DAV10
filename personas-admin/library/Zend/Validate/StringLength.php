...
class Zend_Validate_StringLength extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        ...
        self::INVALID   => "No debe ingresar caracteres inválidos",
        self::TOO_SHORT => "Debe ingresar un valor que contenga al menos %min% letras",
        self::TOO_LONG  => "Debe ingresar un valor que contenga menos de %max% letras",
    );
