...
var cntCaptcha_Servidor="<?php echo JURI::base();?>plugins/content/dicoex/captcha/ajax.php"; // Determina la pagina donde buscar
...
function plugin_do_captcha_comprobar()
{
	...
	if(cntCaptcha_Conexion)
	{
		...
		*	false - Sincronizado */
		...
		cntCaptcha_Conexion.send("juribase=<?php echo JURI::base();?>&"+date.getTime());
	}
}
