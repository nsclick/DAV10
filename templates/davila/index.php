...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo $this->baseurl; ?>assets/colorbox/example1/colorbox.css" />
  <script type="text/javascript" src="<?php echo $this->baseurl; ?>assets/colorbox/jquery.colorbox-min.js"></script>
</head>
<body>
...
<!--script type="text/javascript">
	window.open('<?php JURI::base() ?>?tmpl=popup','','height=480,width=367') 
</script-->
...
<?php /* if($menu->getActive() == $menu->getDefault()) { ?>
  <script type="text/javascript">
    jQuery(document).ready(function(){
      jQuery.colorbox({width:"480px", height:"480px", inline:true, href:"#banner-comite"});
    });
  </script>
  <div style="display:none">
    <img id="banner-comite" src="<?php echo $this->baseurl; ?>/images/banners/Comite-paritario-clinica-davila-PopUp-420x380-pxl.jpg" />
  </div>
<?php } */ ?>
</body>
</html>